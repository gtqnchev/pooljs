...
Ball.prototype.move = function(friction) {
    if(this.speed != 0) {
        this.speed -= this.speed * friction + 0.005;
        ...
        if(Math.abs(this.speed) < 0.1) {
            ...
            this.emit("ball-at-rest");
        }
    }
};

Ball.prototype.strike = function(from) {
    var direction = Geometry.subtractVectors(this, from),
        speed = Geometry.vectorLength(direction) / speedFactor;


    this.dir = Geometry.normalize(direction);
